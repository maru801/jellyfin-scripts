...
###########################################################
## Leaving this blank will check all paths in the libraries
ignoreFilePathsWithThis=".zfs"
###########################################################
...
if [ "$1" == "-c" ]; then
    ...
    if grep -s "removed " $scriptLogLocation | grep -sEi "\\$videoType1|\\$videoType2|\\$videoType3|\\$videoType4|\\$videoType5|\\$videoType6|\\$videoType7|\\$videoType8|\\$videoType9|\\$videoType10|\\$videoType11|\\$videoType12|\\$videoType13|\\$videoType14|\\$videoType15|\\$videoType16|\\$videoType17|\\$videoType18|\\$videoType19|\\$videoType20|\\$videoType21|\\$videoType22|\\$videoType23|\\$videoType24|\\$videoType25|\\$videoType26|\\$videoType27|\\$videoType28|\\$videoType29" -; then
        echo ""
        ...
        for((i = 0 ; i <= ($libraryCount - 1); i++)); do
            if [ ${LibraryEnabledArray[i]//,/} == true ]; then
                if [ "$cleanLeftOverTrickplayFolders" == "1" ]; then
                    grep -vFf <(find "${libraryPathArray[i]//,/}"/* -iname $ignoreFilePathsWithThis -prune -o -type f \( -iname "*$videoType1" -o -iname "*$videoType2" -o -iname "*$videoType3" -o -iname "*$videoType4" -o -iname "*$videoType5" -o -iname "*$videoType6" -o -iname "*$videoType7" -o -iname "*$videoType8" -o -iname "*$videoType9" -o -iname "*$videoType10" -o -iname "*$videoType11" -o -iname "*$videoType12" -o -iname "*$videoType13" -o -iname "*$videoType14" -o -iname "*$videoType15" -o -iname "*$videoType16" -o -iname "*$videoType17" -o -iname "*$videoType18" -o -iname "*$videoType19" -o -iname "*$videoType20" -o -iname "*$videoType21" -o -iname "*$videoType22" -o -iname "*$videoType23" -o -iname "*$videoType24" -o -iname "*$videoType25" -o -iname "*$videoType26" -o -iname "*$videoType27" -o -iname "*$videoType28" -o -iname "*$videoType29" \) | sed 's/\.[^.]*$/.trickplay/gm' | sed 's/\(.*\)/"\1"/g') <(find "${libraryPathArray[i]//,/}"/* -iname $ignoreFilePathsWithThis -prune -o -type d \( -iname "*.trickplay*" \) | sed 's/\(.*\)/"\1"/g') | xargs rm -vrf >> $scriptTempLogLocation
                fi
                grep -vFf <(find "${libraryPathArray[i]//,/}"/* -iname $ignoreFilePathsWithThis -prune -o -type f \( -iname "*$videoType1" -o -iname "*$videoType2" -o -iname "*$videoType3" -o -iname "*$videoType4" -o -iname "*$videoType5" -o -iname "*$videoType6" -o -iname "*$videoType7" -o -iname "*$videoType8" -o -iname "*$videoType9" -o -iname "*$videoType10" -o -iname "*$videoType11" -o -iname "*$videoType12" -o -iname "*$videoType13" -o -iname "*$videoType14" -o -iname "*$videoType15" -o -iname "*$videoType16" -o -iname "*$videoType17" -o -iname "*$videoType18" -o -iname "*$videoType19" -o -iname "*$videoType20" -o -iname "*$videoType21" -o -iname "*$videoType22" -o -iname "*$videoType23" -o -iname "*$videoType24" -o -iname "*$videoType25" -o -iname "*$videoType26" -o -iname "*$videoType27" -o -iname "*$videoType28" -o -iname "*$videoType29" \) -exec basename {} \; | sed 's/\.[^.]*$/./gm') <(find "${libraryPathArray[i]//,/}"/* -iname $ignoreFilePathsWithThis -prune -o -type f \( -iname "*$fileType1" \) | grep -vEi "$ignoreFile1|$ignoreFile2|$ignoreFile3|$ignoreFile4|$ignoreFile5|$ignoreFile6" -) | sed 's/\(.*\)/"\1"/g' | xargs rm -vf >> $scriptTempLogLocation
                grep -vFf <(find "${libraryPathArray[i]//,/}"/* -iname $ignoreFilePathsWithThis -prune -o -type f \( -iname "*$videoType1" -o -iname "*$videoType2" -o -iname "*$videoType3" -o -iname "*$videoType4" -o -iname "*$videoType5" -o -iname "*$videoType6" -o -iname "*$videoType7" -o -iname "*$videoType8" -o -iname "*$videoType9" -o -iname "*$videoType10" -o -iname "*$videoType11" -o -iname "*$videoType12" -o -iname "*$videoType13" -o -iname "*$videoType14" -o -iname "*$videoType15" -o -iname "*$videoType16" -o -iname "*$videoType17" -o -iname "*$videoType18" -o -iname "*$videoType19" -o -iname "*$videoType20" -o -iname "*$videoType21" -o -iname "*$videoType22" -o -iname "*$videoType23" -o -iname "*$videoType24" -o -iname "*$videoType25" -o -iname "*$videoType26" -o -iname "*$videoType27" -o -iname "*$videoType28" -o -iname "*$videoType29" \) -exec basename {} \; | sed 's/\.[^.]*$/-thumb./gm') <(find "${libraryPathArray[i]//,/}"/* -iname $ignoreFilePathsWithThis -prune -o -type f \( -iname "*$fileType2*" \) | grep -Ei ".jpg|.jpeg|.png|.svg|.webp" -) | sed 's/\(.*\)/"\1"/g' | xargs rm -vf >> $scriptTempLogLocation
            fi
        done
    ...
    if grep -s "removed " $scriptLogLocation | grep -sEi "\\$videoType1|\\$videoType2|\\$videoType3|\\$videoType4|\\$videoType5|\\$videoType6|\\$videoType7|\\$videoType8|\\$videoType9|\\$videoType10|\\$videoType11|\\$videoType12|\\$videoType13|\\$videoType14|\\$videoType15|\\$videoType16|\\$videoType17|\\$videoType18|\\$videoType19|\\$videoType20|\\$videoType21|\\$videoType22|\\$videoType23|\\$videoType24|\\$videoType25|\\$videoType26|\\$videoType27|\\$videoType28|\\$videoType29" -; then
        ...
        if [ "$cleanLeftOverTrickplayFolders" == "1" ]; then
            echo "This bash script will delete leftover image thumbnails, nfo, and trickplay related files from the linked libraries in the script."
        else
            echo "This bash script will delete leftover image thumbnails and nfo related files from the linked libraries in the script."
        fi
        echo ""
        ...
        if [ "$userExitChoice" == "Y" ]; then
            ...
            for((i = 0 ; i <= ($libraryCount - 1); i++)); do
                if [ ${LibraryEnabledArray[i]//,/} == true ]; then
                    echo ""
                    if [ "$cleanLeftOverTrickplayFolders" == "1" ]; then
                        echo "-----Cleaning \"${libraryNameArray[i]//,/}\" (rm uneeded $fileType1 + $fileType2 + trickplay files)-----"
                        grep -vFf <(find "${libraryPathArray[i]//,/}"/* -iname $ignoreFilePathsWithThis -prune -o -type f \( -iname "*$videoType1" -o -iname "*$videoType2" -o -iname "*$videoType3" -o -iname "*$videoType4" -o -iname "*$videoType5" -o -iname "*$videoType6" -o -iname "*$videoType7" -o -iname "*$videoType8" -o -iname "*$videoType9" -o -iname "*$videoType10" -o -iname "*$videoType11" -o -iname "*$videoType12" -o -iname "*$videoType13" -o -iname "*$videoType14" -o -iname "*$videoType15" -o -iname "*$videoType16" -o -iname "*$videoType17" -o -iname "*$videoType18" -o -iname "*$videoType19" -o -iname "*$videoType20" -o -iname "*$videoType21" -o -iname "*$videoType22" -o -iname "*$videoType23" -o -iname "*$videoType24" -o -iname "*$videoType25" -o -iname "*$videoType26" -o -iname "*$videoType27" -o -iname "*$videoType28" -o -iname "*$videoType29" \) | sed 's/\.[^.]*$/.trickplay/gm' | sed 's/\(.*\)/"\1"/g') <(find "${libraryPathArray[i]//,/}"/* -iname $ignoreFilePathsWithThis -prune -o -type d \( -iname "*.trickplay*" \) | sed 's/\(.*\)/"\1"/g') | xargs -t rm -vrf >> $scriptTempLogLocation
                    else
                    ...
                    grep -vFf <(find "${libraryPathArray[i]//,/}"/* -iname $ignoreFilePathsWithThis -prune -o -type f \( -iname "*$videoType1" -o -iname "*$videoType2" -o -iname "*$videoType3" -o -iname "*$videoType4" -o -iname "*$videoType5" -o -iname "*$videoType6" -o -iname "*$videoType7" -o -iname "*$videoType8" -o -iname "*$videoType9" -o -iname "*$videoType10" -o -iname "*$videoType11" -o -iname "*$videoType12" -o -iname "*$videoType13" -o -iname "*$videoType14" -o -iname "*$videoType15" -o -iname "*$videoType16" -o -iname "*$videoType17" -o -iname "*$videoType18" -o -iname "*$videoType19" -o -iname "*$videoType20" -o -iname "*$videoType21" -o -iname "*$videoType22" -o -iname "*$videoType23" -o -iname "*$videoType24" -o -iname "*$videoType25" -o -iname "*$videoType26" -o -iname "*$videoType27" -o -iname "*$videoType28" -o -iname "*$videoType29" \) -exec basename {} \; | sed 's/\.[^.]*$/-thumb./gm') <(find "${libraryPathArray[i]//,/}"/* -iname $ignoreFilePathsWithThis -prune -o -type f \( -iname "*$fileType2*" \) | grep -Ei ".jpg|.jpeg|.png|.svg|.webp" -) | sed 's/\(.*\)/"\1"/g' | xargs -t rm -vf >> $scriptTempLogLocation
                fi
            done
